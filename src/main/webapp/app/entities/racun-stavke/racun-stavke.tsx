              ...
              <tbody>
                {racunStavkeList.map((racunStavke, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{racunStavke.artikal ? <Link to={`artikal/${racunStavke.artikal.id}`}>{racunStavke.artikal.id}</Link> : ''}</td>
                    <td>{racunStavke.racun ? <Link to={`racun/${racunStavke.racun.id}`}>{racunStavke.racun.id}</Link> : ''}</td>
