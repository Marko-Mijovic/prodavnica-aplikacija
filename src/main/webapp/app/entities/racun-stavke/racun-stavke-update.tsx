            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : racunStavkeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="racun-stavke-redniBrojStavke" type="string" className="form-control" name="redniBrojStavke" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvInput id="racun-stavke-artikal" type="select" className="form-control" name="artikal.id">
                    <option value="" key="0" />
                    {artikals
                ...
                <AvGroup>
                  ...
                  <AvInput id="racun-stavke-racun" type="select" className="form-control" name="racun.id">
                    <option value="" key="0" />
                    {racuns
