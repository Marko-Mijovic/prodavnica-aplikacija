package com.firedata.prodavnica.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("prodavnica");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("prodavnica");
        ...
        config.getMapConfigs().put("com.firedata.prodavnica.domain.*", initializeDomainMapConfig(jHipsterProperties));
